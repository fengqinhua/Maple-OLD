...
namespace Maple.Web.Environment.AutofacUtil.DynamicProxy2 {
    public class DynamicProxyContext {
        const string ProxyContextKey = "Maple.Web.Environment.AutofacUtil.DynamicProxy2.DynamicProxyContext.ProxyContextKey";
        const string InterceptorServicesKey = "Maple.Web.Environment.AutofacUtil.DynamicProxy2.DynamicProxyContext.InterceptorServicesKey";
