    ...
    public class ExtensionManager : IExtensionManager {
        ...
        private Feature LoadFeature(FeatureDescriptor featureDescriptor) {
            ...
            try {
                ...
                throw new MapleWebCoreException(T("Error while loading extension '{0}'.", extensionId), ex);
            }
        ...
        private static string GetSourceFeatureNameForType(Type type, string extensionId) {
            foreach (MapleFeatureAttribute featureAttribute in type.GetCustomAttributes(typeof(MapleFeatureAttribute), false)) {
