...
namespace Maple.Web.Environment {
    ...
    /// </summary>
    public static class MapleHostContainerRegistry {
        private static readonly IList<Weak<IShim>> _shims = new List<Weak<IShim>>();
        private static IMapleHostContainer _hostContainer;
        ...
        public static void RegisterHostContainer(IMapleHostContainer container) {
            lock (_syncLock) {
                CleanupShims();
