...
namespace Maple.Web.Environment.State {
    public class DefaultProcessingEngine : Component, IProcessingEngine {
        ...
        private readonly Func<IMapleHost> _orchardHost;

        private readonly ContextState<IList<Entry>> _entries;

        public DefaultProcessingEngine(IShellContextFactory shellContextFactory, Func<IMapleHost> orchardHost) {
